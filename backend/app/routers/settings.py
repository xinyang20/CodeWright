...
async def get_published_templates(db: Session = Depends(get_db)):
    ...
    try:
        ...
        return ResponseModel(code=5001, message="获取已发布模板失败")
...
async def get_system_settings(
    ...
    try:
        ...
        return ResponseModel(code=0, message="获取成功", data=await service.get_settings())
    except Exception:
        return ResponseModel(code=5001, message="获取系统设置失败")
...
async def update_system_setting(
    ...
    try:
        ...
        return ResponseModel(code=0, message="设置更新成功", data=settings)
    except ValueError as e:
        return ResponseModel(code=1001, message=str(e))
    except Exception:
        return ResponseModel(code=5001, message="更新系统设置失败")
...
async def get_highlight_mapping(
    ...
    try:
        ...
        return ResponseModel(code=5001, message="获取高亮映射失败")
...
async def update_highlight_mapping(
    ...
    try:
        ...
        return ResponseModel(code=5001, message="更新高亮映射失败")
...
async def get_announcements(
    ...
    try:
        ...
        return ResponseModel(code=5001, message="获取公告失败")
...
async def create_announcement(
    ...
    try:
        ...
        return ResponseModel(code=0, message="公告创建成功", data=announcement)
    except KeyError:
        return ResponseModel(code=1001, message="公告标题和正文不能为空")
    except ValueError as e:
        return ResponseModel(code=1001, message=str(e))
    except Exception:
        return ResponseModel(code=5001, message="创建公告失败")
...
async def update_announcement(
    ...
    try:
        ...
        if not announcement:
            return ResponseModel(code=4001, message="公告不存在")
        return ResponseModel(code=0, message="公告更新成功", data=announcement)
    except ValueError as e:
        return ResponseModel(code=1001, message=str(e))
    except Exception:
        return ResponseModel(code=5001, message="更新公告失败")
...
async def delete_announcement(
    ...
    try:
        ...
        if not await service.delete_announcement(announcement_id):
            return ResponseModel(code=4001, message="公告不存在")
        return ResponseModel(code=0, message="公告已删除")
    except Exception:
        return ResponseModel(code=5001, message="删除公告失败")
